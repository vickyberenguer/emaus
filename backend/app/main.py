...
from app.routers import auth, relevamientos, pastoral_pi, espacios_educativos, talleres, establecimientos, admin, catalogos, control, tablero, admin_ee
...
app.include_router(admin_ee.router)
