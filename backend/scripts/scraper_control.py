...
RUBRO_TEMATICO_DICT = [
    ...
    # --- Clasificación manual de temáticas puntuales (revisadas por Vicky sobre
    # el "Otros" real de la primera corrida) — van al final para no pisar las
    # reglas genéricas de arriba (ej. "ingles" no debe interceptar "Ingles y
    # alfabetización", que ya matchea por "alfabetiz" antes de llegar acá).
    ("arte terapia", "Arte y Expresión Artística"),
    ("ingles", "Formación y Capacitación"),
    ("acciones de pi. reflexion sobre los servicios que prestan en los espacios", "Integración Comunitaria"),
    ("acompanamiento en campamento catequesis", "Espiritualidad y Religión"),
    ("actividades culturales", "Arte y Expresión Artística"),
    ("adicciones / consumo problematico", "Salud Mental y Emocional"),
    ("apoyo en tareas escolares", "Apoyo Escolar y Educativo"),
    ("armado de figuras 3d", "Arte y Expresión Artística"),
    ("belleza integral", "Estética y Cuidado Personal"),
    ("buzon de la vida", "Derechos y Ciudadanía"),
    ("charla sobre la enfermedad del dengue", "Salud y Prevención"),
    ("clown", "Teatro y Expresión"),
    ("conductaas diruptivas", "Salud Mental y Emocional"),
    ("conociendo los sentimientos", "Salud Mental y Emocional"),
    ("consumo problematico", "Salud Mental y Emocional"),
    ("cuidamos nuestra casa", "Huerta y Medio Ambiente"),
    ("elaboracion de panes", "Cocina y Gastronomía"),
    ("elaboracion panificados", "Cocina y Gastronomía"),
    ("emociones", "Salud Mental y Emocional"),
    ("emprendedurismo para ninos", "Oficios y Emprendimiento"),
    ("escritura", "Alfabetización y Lectoescritura"),
    ("espacio de contencion a personas con consumos problematicos", "Salud Mental y Emocional"),
    ("estrategias de estudio", "Apoyo Escolar y Educativo"),
    ("festividades por el dia del padre", "Crianza y Familia"),
    ("grupo de mujeres", "Género y Diversidad"),
    ("habilidades sociales", "Integración Comunitaria"),
    ("los 1000 dias del nino. perfil del lider.", "Primera Infancia y Desarrollo"),
    ("mama mbarete", "Crianza y Familia"),
    ("miedo en escuelas", "Salud Mental y Emocional"),
    ("movimiento corporal", "Danza y Folklore"),
    ("mportancia de las vacunas", "Salud y Prevención"),
    ("mundial 2026", "Juego y Recreación"),
    ("practicas educativas matematica y lengua", "Apoyo Escolar y Educativo"),
    ("practicas profesionalizantes en fonoudiologia", "Salud y Prevención"),
    ("practicas profesionalizantes en trabajo social", "Formación y Capacitación"),
    ("protocolo de abuso sexual infantil.", "Derechos y Ciudadanía"),
    ("reciclaje", "Huerta y Medio Ambiente"),
    ("recreativos", "Juego y Recreación"),
    ("refleccionar sobre la realidad que viven la comunidad al abuso de consumo", "Salud Mental y Emocional"),
    ("rosa guaru", "Historia y Cultura"),
    ("taller con trabajadoras sociales pasantes", "Formación y Capacitación"),
    ("taller cuidar al que cuida", "Salud Mental y Emocional"),
    ("taller de arte", "Arte y Expresión Artística"),
    ("taller de ceramica", "Arte y Expresión Artística"),
    ("taller de ciencias", "Apoyo Escolar y Educativo"),
    ("taller de ingles", "Formación y Capacitación"),
    ("taller de jovenes", "Integración Comunitaria"),
    ("taller de psicovoluntariado", "Salud Mental y Emocional"),
    ("taller de sentimientos en el embarazo", "Salud Mental y Emocional"),
    ("taller desaprender para renacer", "Salud Mental y Emocional"),
    ("taller en vilelas para mochileros", "Turismo y Viajes"),
    ("tecnicas de estudio", "Apoyo Escolar y Educativo"),
    ("terminalidad primaria y secundaria", "Apoyo Escolar y Educativo"),
    ("trabajo en redes", "Integración Comunitaria"),
]

PERFIL_CAPACITADOR_DICT = [
    ("estudiante btu", "Estudiante BTU"),
    ("btu", "Estudiante BTU"),
    ("jubilad", "Docente Jubilado/a"),  # cubre maestra/maestro/docente/profesor + singular/plural
    ...
    ("pediatra", "Médico/a"),
    ("ginecolog", "Médico/a"),
    ("nutricion", "Nutricionista"),  # cubre "nutricionista" y "lic en nutricion"
    ...
    ("hermana", "Religioso/a"),
    ("misionera", "Religioso/a"),
    ("religios", "Religioso/a"),
    ...
    # --- Clasificación manual de fragmentos puntuales (revisados por Vicky
    # sobre el "Otro Profesional" real de la primera corrida) — van al final
    # para no pisar las reglas genéricas de arriba.
    ("lideres de gravida", "Referente"),
    ("promotor socioeducativo", "Referente"),
    ("ref. parroquial", "Referente"),
    ("mamas de becas familiares", "Madre Líder"),
    ("alternativa 3", "Organización Externa"),
    ("mochileros de anatuya", "Voluntario/a"),
    ("equipo diocesano", "Organización Externa"),
    ("diocesano", "Organización Externa"),
    ("promotor sanitario", "Referente"),
    ("ingeniero agronomo", "Profesional"),
    ("fraile franciscano", "Religioso/a"),
    ("lider capacitadora pi", "Madre Líder"),
    ("profesional en educacion especial", "Docente/Profesor/a"),
    ("defensa civil", "Organización Externa"),
    ("policia", "Fuerzas de Seguridad"),
    ("cocinera", "Oficio"),
    ("agentes de salud en terreno", "Referente"),
    ("dentista", "Odontólogo/a"),
    ("padres de ninos fueron los cocineros en toda la colonia.", "Voluntario/a"),
    ("agentes del paippa", "Organización Externa"),
    ("tallerista brindada por cge", "Docente/Profesor/a"),
    ("alfabetizadora", "Docente/Profesor/a"),
    ("coach ontologica profesional", "Profesional"),
    ("agente de salud", "Enfermero/a"),
    ("ceramista", "Artesano/a o Técnico/a"),
    ("instructora", "Docente/Profesor/a"),
    ("facilitadora en arte terapia", "Artesano/a o Técnico/a"),
    ("capacitadora dale", "Docente/Profesor/a"),
    ("fonoudiologa ( taller que ve a realizar en agosto )", "Fonoaudiólogo/a"),
    ("profesionales de laa salud", "Médico/a"),
    ("resferentres pastorales", "Referente"),
    ("equipo motor del espacio y equipo motor admist.", "Referente"),
    ("trabajadores sociales de la univercidad.", "Trabajador/a Social"),
    ("cientifica y escritora victoria cerdeira", "Profesional"),
    ("ingeniera", "Profesional"),
    ("mama bf", "Madre Líder"),
    ("lic. en letras", "Docente/Profesor/a"),
    ("artista", "Artesano/a o Técnico/a"),
    ("agentes de la municipalidad encargados de dar charla sobre le buzon de la vida.", "Organización Externa"),
]
...
_BTU_ABANDONO_MOTIVOS = [
    ...
    ("BTU_abandono_horarios",                "Incompatibilidad de la cursada con horarios laborales"),
]
